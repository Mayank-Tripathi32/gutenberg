...
-   Synced Pattern: Expand shortcodes when the pattern is rendered outside `the_content`, so a Shortcode block inside a synced pattern works in templates instead of printing the raw shortcode.
